...
export const dragController = {
  /**
   * Torna o card de tarefa arrastável e captura seu ID
   */
  ...
  /**
   * Gerencia a zona de drop com Auto-Scroll e Troca de Tarefas (Swap)
   */
  makeFullDayDroppable(dayContainer, onDropTask) {
    dayContainer.addEventListener("dragover", (e) => {
      ...
      // Auto-scroll dentro do container (não na janela)
    ...
    dayContainer.addEventListener("drop", async (e) => {
      ...
      // Identificar o elemento alvo do drop
      ...
      try {
        ...
        // Swap se soltou em cima de outra tarefa
  ...
  /**
   * Remove horário da tarefa (Double Click)
   */
  ...
  makeCompletable(taskElement, taskId) {
    ...
    btn.onclick = async (e) => {
      ...
      try {
        ...
        // Efeitos de gamificação ao concluir tarefa
